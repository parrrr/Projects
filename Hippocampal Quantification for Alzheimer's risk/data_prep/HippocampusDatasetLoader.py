...
def LoadHippocampusData(root_dir, y_shape, z_shape):
    ...
    for f in images:
        ...
        # Need to reshape data since CNN tensors that represent minibatches
        # in our case will be stacks of slices and stacks need to be of the same size.
        # In the inference pathway, need to crop the output to that
        # of the input image.
        ...
        # ANSWER: to make sure that the values in the array are in the same int format for prediction
